...
class Detector:
    ...
    KEYWORDS = {
        ...
        "microboone_numi_fhc": "microboone_numi_fhc.txt",
        "microboone_numi_rhc": "microboone_numi_rhc.txt",
        "microboone_tpc": "microboone_tpc.txt",
        "microboone_dirt": "microboone_dirt.txt",
        "microboone_tpc_numi_fhc": "microboone_tpc_numi_fhc.txt",
        "microboone_tpc_numi_rhc": "microboone_tpc_numi_rhc.txt",
